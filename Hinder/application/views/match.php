        ...
        $.ajax({
            ...
            success: function(match){
                ...
                for(i = 0; i < 6; i++){                    
                    ...
                    beschrijving = match[i].beschrijving.substring(0, 30) + '...';
                    persType = match[i].persType;
                    merkVk = match[i].merkVk;
                    id = match[i].id;
                    
                   var perspic = document.getElementById('img'+[i+1]);
                   var pershref = document.getElementById('a'+[i+1]);
                   var pers = document.getElementById('u'+[i+1]);
...
<div class="content">
    <h1>Matching</h1>
    <hr width="80%">
    <p>Op deze pagina matchen we je met jouw perfecte partner, op basis van jouw persoonlijkheidstype.</p>
    <a class="verzendknop" onclick="pakprofiel()">Match me!</a>
